...
non-nil, determine the visibility as usual, i.e. use the default
default specific to the section (see `magit-insert-section'), or
the fallback default which is `show'."
...
(defun magit-section-cached-visibility (section)
  ...
  (alist-get (magit-section-visibility-ident section)
             magit-section-visibility-cache
             nil nil 'equal))

(cl-defun magit-section-cache-visibility
    (&optional (section magit-insert-section--current))
  (setf (alist-get (magit-section-visibility-ident section)
                   magit-section-visibility-cache
                   nil nil 'equal)
        (if (magit-section-hidden section) 'hide 'show)))
